...
//Issue The Query
$res = pg_query($db,"SELECT * from dealer_payment where dp_id='$dp_id' ");

$count=pg_num_rows($res);
if($count==1)
{
$update = pg_query("UPDATE dealer_payment SET d_status='DONE' where dp_id='$dp_id'");
echo' <script> alert(" Dealer Acknowledgement Successful !!! ")</script> ';
...
<td><input type="text" name="dp_id" maxlength="100" placeholder="Enter Payment ID Here ..." required/></td>
</tr>
...
<a href="Availability.php"><h4>Go To Dealer History </h4></a>
