...
$history = pg_query($db,"SELECT * FROM company_payment where c_email='$emailid'") or die("INVALID QUERY");
$history1 = pg_query($db,"SELECT * FROM requirements where c_email='$emailid'") or die("INVALID QUERY");



?>
<table border=2>
<tr><th colspan=7><center>TRANSACTIONS HISTORY</center></th> 
</tr>
<tr>
<th>Date</th>
<th>Payment ID</th>
...
$_SESSION['req_id']=$data1[0];
$_SESSION['cp_id']= $data[0];
